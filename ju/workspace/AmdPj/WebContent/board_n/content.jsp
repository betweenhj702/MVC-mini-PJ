    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
		...
		<div align='right'>  
			...
			<c:choose>
				<c:when test="${loginUser==boardN.m_email}">
					<a href="board_q.do?m=moveUPage&seq=${boardN.bq_seq}" class="btn btn-success">수정</a>
					<a href="board_q.do?m=delete&seq=${boardQN.bq_seq}" class="btn btn-success">삭제</a>
				</c:when>
				<c:otherwise>
				</c:otherwise>
			</c:choose>
